...
def point_crossing(
    population: List[Individual], parents: List[Tuple[Individual, Individual]], parameters: Dict[str, Any]
) -> List[Individual]:
    """
    ...
    for par_par in parents:
        points = get_points(len(par_par[0].code), parameters)
        children_1 = ""
        children_2 = ""
...
def get_points(length: int, parameters: Dict[str, Any]) -> List[int]:
    """
